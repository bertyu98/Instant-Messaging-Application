...
//	char Data_uname[NAME] = "0";
	...
	fclose(LoginData);
        ...
        fprintf(LoginData,"%s\n", username);
        fprintf(LoginData,"%s\n", password);
        UserData = fopen(strcat(UserDataPath, strcat(usercopy2,".txt")), "w"); /*concatonates username copy string to add txt extension to access specified user's files*/
        fclose(LoginData);
        fclose(UserData);
...
//	FILE *FriendData;
//	FILE *PendingData;
//	char PendingFriendPath[256] = "0";
//	PendingFriendPath = USERSPATH; // Database/Usernames/
//	strcat(PendingFriendPath, friend); // Database/Usernames/friend
//	char FriendDataPath[256] = "0"; 
//	FriendDataPath = PendingFriendPath; // Database/Usernames/friend
//	char UserDataPath[256] = "0"; 
//	UserDataPath = USERSPATH; // Database/Usernames/
//	strcat(UserDataPath, username); // Database/Usernames/username
//	char UserDataPath2[256] = "0";
//	UserDataPath2 = UserDataPath; // Database/Usernames/username
//	strcat(UserDataPath, "/"); // Database/Usernames/username/
//	strcat(PendingFriendPath, "/"); // Database/Usernames/friend/
//	char UserDataPath3[256] = "0";
//	UserDataPath3 = UserDataPath; // Database/Usernames/username/
//	char FriendDataPath2[256] = "0";
//	FriendDataPath2 = PendingFriendPath; // Database/Usernames/friend/
//        char Data_uname[NAME] = "0"; /*Usernames from login file*/
...
//        char friendcopy3[NAME] = "0"; /*copy of iusername to be manipulated*/
//	int Filelength = 0;
...
//		FriendData = fopen(strcat(strcat(strcat(FriendDataPath,"/"),friend),".txt"),"a"); // Database/Usernames/friend/friend.txt
//		UserData = fopen(strcat(strcat(stracat(UserDataPath2,"/"),username)".txt"),"a"); // Database/Usernames/username/username.txt
...
//			PendingData = fopen(strcat(strcat(PendingFriendPath,username),".txt"),"w");
//			return SUCCESSFRIEND;
//
//		}
				
//			UserData = fopen(UserDataPath3, "r"); // opens user's contact files
